...
public class PotionMapper {
    /**
     * Converts a {@link Potion} entity into its corresponding {@link PotionDTO}
     * representation.
     *
     ...
     *
     * <p>This method is typically used when handling potion creation requests
     * from the API layer. The id is not set here and will be assigned by the
     * persistence layer upon saving.</p>
     *
    ...
    /**
     * Converts a {@link Potion} entity into a {@link PotionWithIngredientsDTO},
     * including its associated list of ingredient DTOs.
     *
     * @param potion the potion entity to convert
